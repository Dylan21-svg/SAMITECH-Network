...
export default function SolutionsSection({ onSelectSolution }: SolutionsSectionProps) {
  return (
    <section id="services" className="relative z-10 py-10 sm:py-14 lg:py-20 px-3.5 sm:px-6 lg:px-12 scroll-mt-24 overflow-hidden isolate">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-8 sm:mb-12 lg:mb-16">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 rounded-full bg-[#0B0F17]/90 border border-white/20 shadow-lg mb-3 sm:mb-4">
          ...
          <div className="px-4 py-3 sm:py-4 rounded-2xl bg-[#0B0F17]/90 border border-white/15 shadow-2xl max-w-3xl mb-2 sm:mb-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-2 sm:mb-3">
