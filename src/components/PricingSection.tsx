...
export default function PricingSection({ onSelectPlan }: PricingSectionProps) {
  return (
    <section id="pricing" className="relative z-10 py-10 sm:py-14 lg:py-20 px-3.5 sm:px-6 lg:px-12 scroll-mt-24 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex md:grid md:grid-cols-3 overflow-x-auto md:overflow-visible snap-x snap-mandatory scrollbar-none pb-4 md:pb-0 -mx-3.5 px-3.5 sm:-mx-6 sm:px-6 md:mx-0 md:px-0 gap-3.5 sm:gap-6 md:gap-8 items-stretch">
          {PRICING_PLANS.map((plan, idx) => (
            <div
              key={idx}
              className={`snap-center shrink-0 w-[78vw] xs:w-[285px] sm:w-[330px] md:w-auto rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 flex flex-col justify-between transition-all duration-300 relative backdrop-blur-xl shadow-2xl ${
                plan.highlight
