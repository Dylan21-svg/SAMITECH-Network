...
export default function HeroSection({ onOpenCoverage, onOpenContact }: HeroSectionProps) {
  return (
    <section className="relative min-h-[72vh] lg:min-h-[78vh] flex items-center justify-between overflow-hidden pt-4 pb-12 lg:py-16 px-4 sm:px-6 lg:px-8 isolate">
      ...
      <div className="absolute inset-0 pointer-events-none -z-20 overflow-hidden">
        ...
        <div className="absolute bottom-0 inset-x-0 h-20 bg-gradient-to-t from-[#0B0F17] to-transparent" />
      </div>

      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-center relative z-10">
        
        {/* Left Column: Copy & Actions */}
        <div className="lg:col-span-8 flex flex-col items-start">
          
          {/* Top Pill Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0B0F17]/60 border border-white/20 mb-4 backdrop-blur-md shadow-lg">
          ...
          {/* Main Hero Headline */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-extrabold tracking-tight text-white leading-[1.14] mb-4 drop-shadow-[0_3px_16px_rgba(0,0,0,0.85)]">
          ...
          {/* Subtitle */}
          <p className="text-xs sm:text-sm md:text-base text-gray-100 font-normal leading-relaxed max-w-lg mb-6 drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)]">
          ...
          <div className="flex flex-wrap items-center gap-3.5 mb-8">
            <button
              ...
              className="px-5 py-2.5 rounded-full text-xs sm:text-sm font-bold bg-white text-[#0B0F17] hover:bg-gray-100 hover:shadow-xl hover:shadow-white/10 transition-all duration-200 active:scale-95 flex items-center gap-2 cursor-pointer shadow-lg"
            >
              Get Started
            ...
            <button
              ...
              className="px-4.5 py-2.5 rounded-full text-xs sm:text-sm font-medium bg-[#0B0F17]/70 hover:bg-[#141C2B] text-gray-100 hover:text-white border border-white/20 backdrop-blur-md transition-all duration-200 flex items-center gap-2 active:scale-95 shadow-lg cursor-pointer"
            >
              Check Coverage
          ...
          <div className="p-3 rounded-2xl bg-[#0B0F17]/75 border border-white/20 backdrop-blur-xl shadow-2xl flex items-center gap-3 max-w-sm w-full sm:w-auto">
            {/* Avatar Stack */}
            <div className="flex -space-x-2 overflow-hidden">
              <img
                className="inline-block h-8 w-8 rounded-full ring-2 ring-[#0B0F17] object-cover"
