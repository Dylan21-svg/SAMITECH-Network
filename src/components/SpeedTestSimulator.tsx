            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-10 items-center">
              ...
              <div className="md:col-span-6 flex flex-col justify-between order-1 text-left">
                ...
                <div className="space-y-2.5 w-full max-w-md">
                  ...
                  {/* SLA Guarantee Card */}
                  <div className="flex items-center justify-between p-2.5 sm:p-4 rounded-xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
                ...
                <div className="relative w-full rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 bg-black/40 border border-white/20 shadow-2xl flex flex-col items-center justify-center backdrop-blur-xl">
                  ...
                  <div className="relative w-44 h-44 sm:w-52 sm:h-52 lg:w-56 lg:h-56 flex flex-col items-center justify-center">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                      <span className="text-4xl sm:text-5xl font-black text-white tracking-tight drop-shadow-md">{downloadSpeed}</span>
                      <span className="text-[10px] sm:text-[11px] font-extrabold text-[#0088FF] uppercase tracking-widest mt-0.5">Mbps Download</span>
                      <span className="text-[10px] text-blue-100 font-semibold mt-1.5 bg-white/10 px-2.5 py-0.5 rounded-full border border-white/20 backdrop-blur-sm">Ping: {ping} ms</span>
                    </div>
                  </div>
