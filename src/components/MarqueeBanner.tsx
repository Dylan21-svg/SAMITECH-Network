...
export default function MarqueeBanner() {
  ...
  return (
    <div className="relative z-20 w-full overflow-hidden bg-[#8b0000] text-white py-3.5 sm:py-4 border-y border-black/20 shadow-[0_4px_25px_rgba(139,0,0,0.4)] select-none whitespace-normal sm:whitespace-nowrap">
